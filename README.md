...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&center=true&vCenter=true&width=500&lines=Full-Stack+Engineer;バグ製造兼バグ修正担当;HR+%26+Recruiting+Lead;CDD+(Coffee-Driven+Developer);Vibe+Coder" alt="Typing SVG" />
</p>

<p align="center">
  フルスタックエンジニアとして開発に携わりながら、採用・育成にも関わってきました。<br>
...
| 領域 | 経験 |
|------|------|
| 🖥️ Engineering | 要件定義からリリースまで幅広く担当。フロントエンドやバックエンド、アーキテクト設計まで |
| 👥 HR & Recruiting | 採用担当として年間600名以上と面談し、60名以上の入社をサポート |
| 🎓 Training & Mentoring | 新人研修の講師として約50名の成長に関わり、カリキュラム改善にも取り組んだ |
